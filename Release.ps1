...
$appName = "Easy Android Picture Importer" # 👈 Replace with your application project name.
$projDir = "Easy Android Picture Importer" # 👈 Replace with your project directory (where .csproj resides).
