...
public static class User32
{
    ...
    /// Delegate declaration that matches native WndProc signatures.
    /// </summary>
    public delegate nint WndProcHook(
        nint hWnd,
        WM uMsg,
        nint wParam,
        nint lParam,
    ...
    public static extern nint CreateWindowExW(
        ...
        [In] int nWidth,
        [In] int nHeight,
        [In, Optional] nint hWndParent,
        [In, Optional] nint hMenu,
        [In, Optional] nint hInstance,
        [In, Optional] nint lpParam
    );
    ...
    [DllImport(Libraries.User32, CharSet = CharSet.Unicode)]
    public static extern long GetWindowLongW([In] nint hWnd, [In] int nIndex);
    ...
    /// <returns>If the function succeeds, the return value is the requested value.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern long GetWindowLongA([In] nint hWnd, [In] int nIndex);
    ...
    /// <returns>If the function succeeds, the return value is the requested value.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern long GetWindowLong([In] nint hWnd, [In] int nIndex);
    ...
    /// <returns>If the function succeeds, the return value is the requested value.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern nint GetWindowLongPtrW([In] nint hWnd, [In] int nIndex);
    ...
    /// <returns>If the function succeeds, the return value is the requested value.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern nint GetWindowLongPtrA([In] nint hWnd, [In] int nIndex);
    ...
    /// <returns>If the function succeeds, the return value is the requested value.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern nint GetWindowLongPtr([In] nint hWnd, [In] int nIndex);
    ...
    [DllImport(Libraries.User32, CharSet = CharSet.Unicode)]
    public static extern long SetWindowLongW(
        [In] nint hWnd,
        [In] int nIndex,
        [In] long dwNewLong
    );
    ...
    /// <returns>If the function succeeds, the return value is the previous value of the specified 32-bit integer.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern long SetWindowLong([In] nint hWnd, [In] GWL nIndex, [In] long dwNewLong);
    ...
    /// <returns>If the function succeeds, the return value is the previous value of the specified 32-bit integer.</returns>
    [DllImport(Libraries.User32, CharSet = CharSet.Auto)]
    public static extern long SetWindowLong([In] nint hWnd, [In] GWL nIndex, [In] WS dwNewLong);
    ...
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool DestroyIcon([In] nint handle);
    ...
    [DllImport(Libraries.User32, CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool DestroyWindow([In] nint hWnd);
    ...
    [DllImport(Libraries.User32, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetWindowPlacement([In] nint hWnd, [In] WINDOWPLACEMENT lpwndpl);
    ...
    [DllImport(Libraries.User32, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetWindowRect([In] nint hWnd, [Out] out RECT lpRect);
    ...
    [DllImport(Libraries.User32)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool IsWindowVisible([In] nint hWnd);
    ...
    [DllImport(Libraries.User32)]
    public static extern int GetSystemMetricsForDpi([In] SM nIndex, uint dpi);
    ...
    public static MF EnableMenuItem([In] nint hMenu, [In] SC uIDEnableItem, [In] MF uEnable)
    {
    ...
    private static extern bool _SetWindowPos(
        [In] nint hWnd,
        [In, Optional] nint hWndInsertAfter,
        [In] int x,
        [In] int y,
        [In] int cx,
        [In] int cy,
    ...
    public static void SetPerMonitorAwareV2()
    {
    ...
    public static extern uint GetDpiForWindow([In] nint hWnd);
